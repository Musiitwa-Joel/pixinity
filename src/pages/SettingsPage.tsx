          ...
          >
            ...
            {activeTab === 'profile' && (
              <div className="bg-white rounded-xl border border-neutral-200 p-8">
                <div className="flex items-center justify-between mb-8">
                  <div>
                    <h2 className="text-2xl font-bold text-neutral-900 mb-2">Profile Information</h2>
                    <p className="text-neutral-600">Update your personal information and profile details</p>
                  </div>
                  <button
                ...
                <form onSubmit={profileForm.handleSubmit(handleProfileUpdate)} className="space-y-6">
                  ...
                  <div className="flex items-center space-x-6">
                    <img
                      src={user?.avatar || `https://ui-avatars.com/api/?name=${user?.firstName}+${user?.lastName}&background=2563eb&color=ffffff&size=80`}
                      alt="Profile"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        type="text"
                        disabled={!isEditing}
                        className={`input ${!isEditing ? 'bg-neutral-50 cursor-not-allowed' : ''}`}
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-neutral-700 mb-2">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          type="text"
                          disabled={!isEditing}
                          className={`input pl-8 ${!isEditing ? 'bg-neutral-50 cursor-not-allowed' : ''}`}
                        />
                      </div>
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={4}
                      disabled={!isEditing}
                      className={`input resize-none ${!isEditing ? 'bg-neutral-50 cursor-not-allowed' : ''}`}
            ...
            {activeTab === 'account' && (
              <div className="space-y-8">
                ...
                <div className="bg-white rounded-xl border border-neutral-200 p-8">
                  ...
                  <p className="text-neutral-600 mb-6">Update your password to keep your account secure</p>
            ...
            {activeTab === 'privacy' && (
              <div className="bg-white rounded-xl border border-neutral-200 p-8">
                ...
                <p className="text-neutral-600 mb-8">Control who can see your content and profile information</p>
                ...
                <div className="space-y-6">
                  {[
                    ...
                    <div key={index} className="flex items-center justify-between p-4 bg-neutral-50 rounded-lg">
                      <div>
                        <h3 className="font-medium text-neutral-900">{setting.title}</h3>
            ...
            {activeTab === 'notifications' && (
              <div className="bg-white rounded-xl border border-neutral-200 p-8">
                ...
                <p className="text-neutral-600 mb-8">Choose what notifications you want to receive</p>
                    ...
                    <div key={categoryIndex}>
                      ...
                      <div className="space-y-4">
                        {category.settings.map((setting, settingIndex) => (
                          <div key={settingIndex} className="flex items-center justify-between p-4 bg-neutral-50 rounded-lg">
                            <span className="text-neutral-900">{setting.name}</span>
                            <label className="relative inline-flex items-center cursor-pointer">
                              <input
                                type="checkbox"
                                defaultChecked={setting.enabled}
            ...
            {activeTab === 'preferences' && (
              <div className="bg-white rounded-xl border border-neutral-200 p-8">
                <h2 className="text-2xl font-bold text-neutral-900 mb-2">App Preferences</h2>
                <p className="text-neutral-600 mb-8">Customize your app experience</p>
                ...
                <div className="space-y-8">
                      ...
                      {[
                        ...
                        <label key={theme.id} className="relative">
                          ...
                          <div className={`p-4 border-2 rounded-xl cursor-pointer transition-all ${
                            ...
                            <div className="font-medium text-neutral-900">{theme.label}</div>
                          </div>
                        </label>
                      ))}
                    </div>
                  ...
                  {/* Language */}
                  <div>
                    <h3 className="text-lg font-semibold text-neutral-900 mb-4">Language</h3>
                  ...
                  {/* Other Preferences */}
                  <div>
                    <h3 className="text-lg font-semibold text-neutral-900 mb-4">Display</h3>
                    <div className="space-y-4">
                      {[
                        { name: 'Show photo metadata by default', enabled: true },
